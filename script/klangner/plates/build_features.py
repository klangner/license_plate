...
if __name__ == "__main__":
    ...
    features = [graph.parse_image(folder + fp) for fp in os.listdir(folder)]
    ...
    print('Parsed {} images in {} seconds'.format(len(features), total_time))
    df.to_csv('../../../data/classifier/train.csv')
